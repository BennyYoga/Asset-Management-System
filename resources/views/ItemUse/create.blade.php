...
@section('title','Assets Monitoring System | Add Item Use')
...
<section class="tab-components">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="itemuse.index">Item Use</a>
                            </li>
    ...
    <form action="" id="ItemReqForm" method="post">
        @csrf
    </form>
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            ...
                            <div class="input-style-1">
                                ...
                                @error('Notes') <span class="text-danger"></span> @enderror
                            </div>
                        </div>
