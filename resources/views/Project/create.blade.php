...
@section('title','Assets Management System | Create Project')
...
<section class="tab-components">
    ...
    <form action="{{route('project.store')}}" method="post" id="proj">
        @csrf
        @method('POST')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card-style mb-30">
                        ...
                        <input type="text" placeholder="Start Date" name="StartDate" required class="datepicker"/>
                        </div>
                        <div class="input-style-1 col-lg-6">
                            <label>EndDate</label>
                            <input type="text" placeholder="End Date" name="EndDate" required class="datepicker"/>
                        </div>
                        <!-- end input -->
                        <!-- end input -->
