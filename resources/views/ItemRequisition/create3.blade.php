                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <form action="{{ route('dropzone.store') }}" method="post" name="file"
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-end align-items-center">
                    ...
                    <div class="form-check checkbox-style mb-20">
                        ...
                        <input type="checkbox" class="form-check-input" value id="checkbox-1" form="ItemReqForm">
                    </div>
                </div>
                <!-- end col -->
            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-check checkbox-style mb-30">
                                    <input type="checkbox" class="form-check-input" id="checkbox-2" form="ItemReqForm">
                                    <label for="checkbox-2">Nama Pegawai/Jabatan</label>
                                </div>
                                <div class="form-check checkbox-style mb-30">
                                    <input type="checkbox" class="form-check-input" id="checkbox-3" form="ItemReqForm">
                                    <label for="checkbox-3">Nama Pegawai/Jabatan</label>
                                </div>
                                <h6 class="mb-10">Approval 2</h6>
                                <div class="form-check checkbox-style mb-30">
                                    <input type="checkbox" class="form-check-input" id="checkbox-4" form="ItemReqForm">
