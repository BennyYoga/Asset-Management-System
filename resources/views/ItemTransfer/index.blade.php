...
@section('title','Assets Management System | Item Transfer')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('itemtransfer.create') }}" class="btn btn-primary mr-2">Add</a>
                    </div>
                </div>
                <!-- end col -->
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card-style mb-30">
                            <div class="table-wrapper table-responsive">
                                ...
                                <table class="table" id="itemtransfer">
                                    <thead>
                                        <tr class="text-left">
                                            <th>No</th>
                                            <th>Tanggal</th>
...
<script>
    $(document).ready(function () {
        ...
        $('#itemtransfer').on('click', '#hapusBtn', function (e) {
            e.preventDefault();
...
<script type="text/javascript">
    $(document).ready(function () {
    var table = $('#itemtransfer').DataTable({
        processing: true,
        serverSide: true,
        ajax: "",
        columns: [
