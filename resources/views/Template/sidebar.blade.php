...
<aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            @endif
            @if($menu->contains('MenuId', 7.2) || $role === 'SuperAdmin' || $role === 'Admin Lokasi')
                ...
                <a href="{{route('project.index')}}">
                    <span class="icon">
                        <svg width="22" height="22" viewBox="0 0 22 22">
                            ...
                            <path d="M7.29166 14.375C6.94648 14.375 6.66666 14.6548 6.66666 15C6.66666 15.3452 6.94648 15.625 7.29166 15.625H17.7083C18.0535 15.625 18.3333 15.3452 18.3333 15C18.3333 14.6548 18.0535 14.375 17.7083 14.375H7.29166Z"/>
                        </svg>
                    </span>
        ...
        @if($menu->contains('MenuId', 9) || $role === 'SuperAdmin' || $role === 'Admin Lokasi')
        <ul>
